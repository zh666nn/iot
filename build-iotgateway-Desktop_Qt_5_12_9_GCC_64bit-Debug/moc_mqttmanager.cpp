...
#include "../iotgateway/mqttmanager.h"
...
QT_MOC_LITERAL(1, 12, 10), // "ledCommand"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3), // "cmd"
QT_MOC_LITERAL(4, 28, 13), // "buzzerCommand"
QT_MOC_LITERAL(5, 42, 17), // "publishSensorData"
QT_MOC_LITERAL(6, 60, 10), // "SensorData"
QT_MOC_LITERAL(7, 71, 4), // "data"
QT_MOC_LITERAL(8, 76, 11), // "onConnected"
QT_MOC_LITERAL(9, 88, 17), // "onMessageReceived"
QT_MOC_LITERAL(10, 106, 7), // "message"
QT_MOC_LITERAL(11, 114, 14), // "QMqttTopicName"
QT_MOC_LITERAL(12, 129, 5) // "topic"

    },
    "MqttManager\0ledCommand\0\0cmd\0buzzerCommand\0"
    "publishSensorData\0SensorData\0data\0"
    "onConnected\0onMessageReceived\0message\0"
...
void MqttManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ledCommand((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->buzzerCommand((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->publishSensorData((*reinterpret_cast< const SensorData(*)>(_a[1]))); break;
        case 3: _t->onConnected(); break;
        case 4: _t->onMessageReceived((*reinterpret_cast< const QByteArray(*)>(_a[1])),(*reinterpret_cast< const QMqttTopicName(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MqttManager::ledCommand)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MqttManager::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MqttManager::buzzerCommand)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MqttManager::ledCommand(const QString & _t1)
{
...
// SIGNAL 1
void MqttManager::buzzerCommand(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
